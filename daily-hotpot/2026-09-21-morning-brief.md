...
检索截止：**2026-09-21 10:57 CST（Asia/Shanghai）**。筛选窗口：**2026-06-21 至检索时点**，含起始日；论文按官方 v1 日期，GitHub 新项目按创建日期，原始时间为 UTC。增量基线为 9 月 19 日晨报（803f7d4），并检索历史简报去重。今天周一，不更新周报。
